...
public class UICliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Carnet", "Nombre", "Apellidos", "Dirección", "Telefono"
            }
        ) {
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jCTextNombre, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(jCTextApellidos, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jCTextDireccion, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jCTextTelefono, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void jbtnRegistarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnRegistarActionPerformed
        ...
        Mensaje mensaje = servicioPersona.Registrar(jctextCarnet.getText(),
                ...
                ,jCTextTelefono.getText(),null,null,TipoPersonal.P_CLI);
    ...
    public void setDato(Persona clienteSelet) {
        this.id = String.valueOf(clienteSelet.getId());
        jctextCarnet.setText(clienteSelet.getCarnet());
        jCTextNombre.setText(clienteSelet.getNombre());
        jCTextApellidos.setText(clienteSelet.getApellidos());
        jCTextDireccion.setText(clienteSelet.getDireccion());
        jCTextTelefono.setText(clienteSelet.getTelefono());
         
    }
    

    private void actualizartabla(){
         this.listar(servicioPersona.listarPersonaCliente());
    }
    
    private void listar(List<Persona> datos){
        DefaultTableModel clientes = new DefaultTableModel();
        clientes.setColumnIdentifiers(new String[]{"Carnet", "Nombre", "Apellidos", "Dirección", "Telefono"});
        for (int i = 0; i < datos.size(); i++) {
             clientes.addRow(new String[]{
